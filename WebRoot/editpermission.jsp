...
<html>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#quxiao").click(function(){
				window.location.href="manageuser/searchpermission";
			});
		//点击确定按钮
			$("#queding").click(function(){
				$.ajax({
					type:"post",
					url:"manageuser/editpermission",
					data:$("form").serialize(),
  ...
  <div class="xiangdao">
	<ol class="breadcrumb">
		...
		<li><a href="manageuser/searchpermission">权限管理</a></li>
	  ...
	  <div class="col-sm-offset-2 col-sm-8">
	    <form class="form-horizontal" role="form">
			  ...
			  <div class="form-group">
			    <label for="qxmc" class="col-sm-offset-1 col-sm-2 control-label">权限名称</label>
			    <div class="col-sm-6">
			    	<c:forEach items="${plist }" var="item" varStatus="status">
			    		<input type="text" value="${item.id }" name="qxid" class="sr-only"/>
						<input type="text" class="form-control" value="${item.name }" name="qxmc" id="qxmc" placeholder="请输入权限名称">
					</c:forEach>
			  ...
			  <div class="form-group">
			    <label for="qxbs" class="col-sm-offset-1 col-sm-2 control-label">权限标识</label>
			    <div class="col-sm-6">
			    	<c:forEach items="${plist }" var="item" varStatus="status">
						<input type="text" class="form-control" value="${item.module }" name="qxbs" id="qxbs" placeholder="请输入权限标识">
					</c:forEach>
