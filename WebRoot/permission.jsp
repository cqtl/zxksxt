...
<html>
	...
	<script type="text/javascript">
		...
		//删除权限
			$("button[name='delete']").click(function(){
				...
				$.ajax({
					type:"post",
					url:"manageuser/deletepermission",
			...
			$("button[name='edit']").click(function(){
				var permissionid=0;
				permissionid=$(this).attr("id");
				window.location.href="manageuser/editpermissionpage ?permissionid="+permissionid;
			});
  ...
  <div class="col-sm-offset-2 col-sm-8">
        <a href="manageuser/addpermissionpage" class="btn btn-info btn-lg">
