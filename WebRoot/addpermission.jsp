	  ...
	  <div class="col-sm-offset-2 col-sm-8">
	    <form class="form-horizontal" role="form">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" name="qxmc" id="qxmc" placeholder="请输入权限名称">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" name="qxbs" id="qxbs" placeholder="请输入权限标识">
			    </div>
			  </div>
			  
			  <div class="form-group">
			    <label for="role" class="col-sm-offset-1 col-sm-2 control-label">需赋予的角色</label>
			    <div class="col-sm-6">
